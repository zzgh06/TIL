...
### **💻 금일 회고**
    이틀 연속의 프로젝트 실습날, 오늘은 어제보다 진행이 매끄러웠다, 좋은 조원분들을 만나서 의미있는 결과를 만들 수 있었던 것 같아서 만족스럽다.
    요즘은 더욱 햇님반에 들어오기 잘한 것 같다는 기분이 든다, 자극도 많이 받고 좋은 아이디어를 통해 좋은 발전을
    이룰 수 있어서 그런 것 같다.
    저녁에는 sqld 강의를 들은 후 문제풀이를 진행하였는데 아직 이해가 부족해서 코드에 따른 실행문 결과를 해석하는
    부분이 많이 어려운 것 같다, 그래서 다음주가 바로 시험이니 새벽운동 대신 sqld 공부에 시간을 더 투자하고자 한다.
