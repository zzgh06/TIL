...
### **💻 금일 회고**
    web, 역시나 조금씩 복잡해진다, 배운 것을 이해하고 사용한다기보다, 억지로 사용해서 활용능력이 다소 떨어지는 것 같다.
    햇님반 데일리스크럼 시간 때, 알고리즘 풀이를 진행했는데 반은 이해되고 반은 이해가 안된다.
    나도 chat GPT 선생님에게 물어봐야겠다...ㅎ(저는 말하는 감자입니다)
    그리고 오늘 목표달성을 위해 달리려던 순간 친구에게 전화가 와서 1시간 넘게 띵까띵까 보내버렸다, 내일 고해성사의 시간을 갖기로 😇
      
### **📒 금일 알고리즘 풀이**
    6057 : 설탕과자 뽑기 / 프로그래머스 sql Lv 4 : 1문제 
