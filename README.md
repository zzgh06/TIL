...
### **💻 금일 회고**
    오늘은 SQL 검색과 관련하여 배우고 실습을 진행하였다, 얼마만에 느껴보는 여유로운 난이도인지... 나도 모르게 헤이해졌다 😵
    그래서 정신 차릴겸 수업 종료 후에, 백준 알고리즘 풀이에 들어갔다, 어제보다 난이도 높은 문제들을 셀렉하여 문제풀이를
    진행하였는데, SQL 문제는 상대가 되지를 않는다 머리가 깨질 것 같다🤯
    정신차리고 익숙해질때까지 계속 문제풀이를 진행하여야겠다!!
    
### **📒 금일 백준 알고리즘 풀이**
    10866 : 덱 / 2605 : 줄세우기 / 2644 : 촌수계산
