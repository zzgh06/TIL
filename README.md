...
### **💻 금일 회고**
    금일 학습 및 실습 내용도 그리 어려운 내용이 아니라 금방 끝낼 수 있었다. 그래서 남는 시간에도 틈틈히
    sqld 및 코드트리 문제풀이를 진행하였다. 비록 근래에 컨디션 관리를 제대로 하지 못해서 집중은 잘 안되었지만
    그럼에도 불구하고 금일 해야될 학습량은 채울 수 있어서 다행이다.
    오늘은 일찍 자고 일어나서 몸을 좀 회복해야 남은 일주일도 열심히 학습할 수 있을 것 같아 이만 물러간다~
