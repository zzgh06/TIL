...
### **💻 금일 회고**
    금일은 bootstrap을 통해 web 실습을 진행하였다, 역시 직종이 직종인 지라 선배 개발자분들이 만들어 놓으신 기술의 집약체에
    이마를 탁 짚으며 실습을 진행하였다.
    햇님반 스터디 블로그 공유 날인지도 까먹고 못해서, 실습을 빨리 끝낸 후에 바로 못풀었던 코드트리 문제 풀이 후에 정리하여 
    블로그 작성을 완료하였다.
    그리고 저녁에는 sqld에 집중하여 자습을 진행하였다. 시험볼 때까진 sqld를 중심으로 자습하고자 한다(한번에 합격하자!!)
