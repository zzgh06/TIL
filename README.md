...
### **💻 금일 회고**
    전일 sql 강의보다 금일 강의가 쉬어서 오늘은 문제풀이를 빨리 끝낼 수 있어서 시간적으로 여유가 있어서 좋았다.
    그래서 남는 시간에 금일 강의 내용을 정리하고, 저녁 자습시간에는 알고리즘 풀이를 진행하였다.
    정답률이 높은 순서대로 D2 ~ D3 문제 풀이를 진행하였다, 며칠 제대로 안 풀었다고 좀 막히는 부분도 있었다.
    이래서 강사님들이 쉬지말고 알고리즘 풀이를 하라고 하신 것 같다, 우선 정답률이 높은 순서대로 문제 풀이를
    계속 도전해나가야 할 것 같다 📝💪
    
### **📒 금일 알고리즘 풀이**
    1926. 간단한 369게임 / 1986. 지그재그 숫자 / 1284. 수도 요금 경쟁 / 12368. 24시간 / 13218. 조별과제
