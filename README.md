...
### **💻 금일 회고**
    오늘은 sql 과정 마지막 날이였다, 모델링에 대해 이해가 부족해서 실습을 엉망징창으로 해서 코드리뷰 시간 때, 좀 부끄러웠다 😞
    그래도 sql 과정은 종료되었으니, 까먹지 않도록 sqld 자격시험을 준비와 문제풀이를 진행하면서 계속 공부해야겠다.
    수업 종료 후, 전일 햇님반에서 정한 알고리즘 문제, 코드리뷰를 진행하였다, 다른 사람들의 풀이를 보면서 왜 강사님이 알고리즘
    스터디를 추천하셨는지 이유를 알았다. 함수, 메서드 기능에 대한 이해가 부족했던 부분들을 다른 사람들의 코드리뷰를 통해 채울 수 있어서 좋았다. 
    
### **📒 금일 알고리즘 풀이**
    10866 : 덱 / 프로그래머스 sql Lv 1 ~ 2 : 20문제 
