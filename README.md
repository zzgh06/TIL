...
### **💻 금일 회고**
    오늘은 sql 수업은 졸면서 들어서 그런지, 오후에 문제풀때 좀 애를 먹었다, 내일이 더 어렵다고 하던데, 정신 바짝차리고 해야겠다.
    프로그래머스에 들어가 알고리즘 풀이를 진행하려다 사용법을 도저히 모르겠어서 포기하고 swea에 들어가 두 문제만 풀었다.
    뭔가 피곤해서 그런지 해이해지는 것 같다, 내일은 좀 정신차리고 해야지;;
    
### **📒 금일 알고리즘 풀이**
    2043. 서랍의 비밀번호, 1933. 간단한 N 의 약수
