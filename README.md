...
### **💻 금일 회고**
    오늘도 아침부터 졸았다..., 오후 실습도 제대로 못풀어서 속상했지만, 그대로 출제자의 의도대로는 푼것 같아서
    다행이다, 내일은 좀더 수업시간에 집중해서 오후 실습도 원만하게 진행되었으면 좋겠다.
    햇님반 프로젝트가 본격적으로 시작되었다, 기여도가 현저히 떨어진다고 생각해서 좀 더 프로젝트에 집중을 해야겠다고
    생각했다. sqld 시험결과가 어찌됐든 빨리 시험이 끝나서 놓고있는 알고리즘도 다시 손을 대야겠다고 생각되는
    하루였다. 시간이 지날수록 해야될게 많아져 정신이 없는 것 같다ㅠ
